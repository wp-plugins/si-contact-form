...
<html>
<head>
  <title>SI Captcha (Secureimage) Test Script</title>
</head>

<body>

<h2>SI Captcha (Secureimage) Test Script</h2>
<p>
  This script will test your PHP installation to see if SI Captcha (Secureimage) will run on your server.
</p>
...
<?php else: ?>
Based on the requirements, you do not have what it takes to run SI Captcha (Secureimage) :(
<?php endif; ?>

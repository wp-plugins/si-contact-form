 ...
 * @version 1.0.3.1m.2 (Aug 28, 2009) with MikeChallis fixes (see below)
 * @package Securimage
 *
 */
...
/**
  ...
  - Added Automatic fail over to GD Fonts instead of TTF Fonts if the PHP installation is configured without "--with-ttf".
...
class Securimage {
  ...
  function drawWord()
  {
    if ($this->use_gd_font == true || !function_exists('imagettftext')  ) { // MikeChallis added  !function_exists('imagettftext')
